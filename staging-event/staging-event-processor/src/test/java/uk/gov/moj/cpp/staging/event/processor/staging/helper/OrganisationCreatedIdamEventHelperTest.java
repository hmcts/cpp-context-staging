...
class OrganisationCreatedIdamEventHelperTest {
    ...
    void shouldProcessOrganisationCreated() {
        ...
        jsonEnvelope = buildMessageForOrganisationCreatedIdamEvent(organisationCreatedEvent);
        organisationCreatedIdamEventHelper.processOrganisationCreated(jsonEnvelope);
    ...
    private void assertOrganisationCreatedCommandSent(final JsonEnvelope sourceEvent) {
