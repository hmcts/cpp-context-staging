...
public class OrganisationUpdatedIdamEventHelper {
    ...
    @Handles("some.thing.something.OrganisationUpdatedIdamEventHelper")
    public void something(final JsonEnvelope event) {
    }

    public void processOrganisationUpdated(final JsonEnvelope event) {
            send(event, "usersgroups.update-organisation-with-details", buildUpdateOrganisationCommand(event));
    }
