package uk.gov.moj.cpp.staging.healthchecks;
...
@Specializes
public class StagingIgnoredHealthcheckNamesProvider extends DefaultIgnoredHealthcheckNamesProvider {

    public StagingIgnoredHealthcheckNamesProvider() {
